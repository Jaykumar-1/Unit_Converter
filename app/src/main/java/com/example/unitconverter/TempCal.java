...
public class TempCal extends AppCompatActivity {
    ...
    String[] unit = {"Degree Celsius","Degree Fahrenheit","Kelvin"};
        ...
        btnConvert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((setUnit1.getText().toString()).equals("") || (setUnit2.getText().toString()).equals("")){
                    Toast.makeText(TempCal.this, "Please Enter the unit", Toast.LENGTH_SHORT).show();
                }
                if((editFrom.getText().toString()).equals("")){
                    Toast.makeText(TempCal.this, "Enter some Value", Toast.LENGTH_SHORT).show();
                }
