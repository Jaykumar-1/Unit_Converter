...
public class WeightCal extends AppCompatActivity {
    ...
    String[] unit = {"Kilogram","Gram", "Milligram"};
        ...
        btnConvert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((setUnit1.getText().toString()).equals("") || (setUnit2.getText().toString()).equals("")){
                    Toast.makeText(WeightCal.this, "Please Enter the unit", Toast.LENGTH_SHORT).show();
                }
                if((editFrom.getText().toString()).equals("")){
                    Toast.makeText(WeightCal.this, "Enter some Value", Toast.LENGTH_SHORT).show();
                }
